...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    @foreach ($category->nominees as $nominee)
                        <div
                            ...
                            @else
                                <img src="https://placehold.co/600x400" alt="Sem Foto"
                                    class="w-full aspect-[335/376] object-cover">
                            @endif
                            ...
                            <div class="p-6">
                                <h3
                                    class="text-[13px] leading-[20px] font-medium text-[#1b1b18] dark:text-[#EDEDEC] mb-2">
                                    {{ $nominee->name }}
                                </h3>
                                ...
                                @auth
                                    ...
                                    @else
                                        <button
                                            onclick="vote({{ $award->id }}, {{ $category->id }}, {{ $nominee->id }})"
    ...
    @auth
        <script>
            ...
            function showMessage(message, type) {
                ...
                container.className = `mb-6 max-w-2xl mx-auto p-4 rounded-sm border ${
            type === 'success'
